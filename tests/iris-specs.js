describe('Iris flower dataset', function () {
    'use strict';
    ...
    describe('', function () {
        it('BackPropagation', function () {
            ...
            const train = new BackPropagation(network, trainDatasetInput, trainDatasetOutput);
        ...
        it('ManhattanPropagation', function () {
            // train the neural network
            const train = new ManhattanPropagation(network, trainDatasetInput, trainDatasetOutput);
